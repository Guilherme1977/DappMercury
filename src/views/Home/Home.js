        ...
        <Grid item xs={12} sm={8} >
          <Card class="override" style={{ height: '100%',  color: "white",background: "black", boxShadow: "none", border: "1px solid var(--black)", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
            <CardContent align="center" >
              ...
              <Button target="_blank" href="https://spookyswap.finance/swap?outputCurrency=0x1D528583F55B5077263288e42E99f73f5Ec045D0"  className={classes.button} variant="outlined" style={{ marginRight: '10px', backgroundColor:'#8000ff' }}>
                BUY MERCURY
              </Button>
              <Button target="_blank" href="https://spookyswap.finance/swap?outputCurrency=0x76FDaD6F805Fc23fE9e4F4B3f980A2692E041546"  className={classes.button} variant="outlined" style={{ marginRight: '10px' , backgroundColor: 'white', color: 'black'}}>
                BUY XSHARE
              </Button>
